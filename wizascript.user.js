...
Version: v${version}`;
  ...
  var DECKS_URL = "https://raw.githubusercontent.com/theWiza2341/Wizascript-assets/refs/heads/main/bot/decks.json";
  function loadDecks() {
    return new Promise((resolve, reject) => {
      GM_xmlhttpRequest({
        method: "GET",
    ...
    registerPresetType(
      {
        ...
        sprite: null,
        soul: null,
        // not soul-tied - this is a card-specific tracker, not a whole-Soul strategy one
        custom: false,
        kind: "event"
      },
      {
...
`;
  ...
  var SOUND_BASE_URL = "https://raw.githubusercontent.com/theWiza2341/Wizascript-assets/main/misc/sounds/";
...
`;
  ...
  function initMisc(plugin) {
    ...
    plugin.events.on("connect", (data) => {
      ...
      resetDoomOverlayForMatchStart((_b = data == null ? void 0 : data.turn) != null ? _b : 0);
    });
  }
